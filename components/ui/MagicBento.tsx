...
// Exported for reuse in other sections
...
export const GlobalSpotlight: React.FC<{
    ...
    `;
            ...
            const handleMouseMove = (e: MouseEvent) => {
                ...
                const section = gridRef.current.closest('.bento-section') || gridRef.current; // Flexible selector
                const rect = section?.getBoundingClientRect();
                const mouseInside =
                    rect && e.clientX >= rect.left && e.clientX <= rect.right && e.clientY >= rect.top && e.clientY <= rect.bottom;

                isInsideSection.current = mouseInside || false;
                const cards = gridRef.current.querySelectorAll('.card, .magic-card'); // Support multiple class names
